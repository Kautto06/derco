...
void mostrarMenuPrincipal(){
    ...
    printf("        | 5. Mostrar Modelos y Marcas de autos vendidos por zona |\n");
    printf("        | 6. Mostrar Cliente que mas ha gastado en sus compras   |\n");
    printf("        | 7. Mostrar Sucursal con mayor distribucion             |\n");
    printf("        | 8. Mostrar Promedio de ventas de sucursales            |\n");
    printf("        | 9. Autos con mas recalls                               |\n");
    printf("        | 10. Fusionar Sucursales                                |\n");
